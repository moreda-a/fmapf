...
public class COGP_Value extends Value {

	public COGP_Value(int num, double value) {
		this.num = num;
		this.value = value;
		bestValue = value;
	}

	public COGP_Value(int i, double d, boolean[] m) {
		this.num = i;
		this.value = d;
		bestValue = value;
		this.mark = m;
	...
	public int compareTo(COGP_Value vv) {
		if (value < vv.value)
			return -1;
		else
			return 1;
	...
	public int compareToBest(COGP_Value vv) {
	...
	public static COGP_Value win() {
		return new COGP_Value(-1, 1);
	}

	public static COGP_Value lose() {
		return new COGP_Value(-1, -1);
	}

	public static COGP_Value draw() {
		return new COGP_Value(-1, 0);
	}
...
//	}
	...
	@Override
	public COGP_Value update(State state, Value simulationResult) {
		COGP_State st = (COGP_State) state;
		COGP_Value simulation_result = (COGP_Value) simulationResult;
		++num;
